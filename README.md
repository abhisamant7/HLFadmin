...
```
*Note: This is a home Kubernetes environment however most of what is covered here should delete to any cloud provider that provides Kubernetes compatible services.*  
...
Now, assuming the NFS server is up & running and with the correct permissions, we're going to create our `PersistentVolume`. First lets create the file `kubernetes/fabric1-pv.yaml` like the example below:
```yaml
...
Now let's delete the above configuration:
```sh 
kubectl delete -f kubernetes/fabric1-pv.yaml
```

After that we'll need to create a `PersistentVolumeClaim`. To do that, we'll create file `kubernetes/efs-volume-claim.yaml` as below:
```yaml
...
Now let's delete the above configuration:
```sh
kubectl delete -f kubernetes/efs-volume-claim.yaml
```
...
After creating the file, let's delete it to our kubernetes cluster: 
```sh
...
Now let's delete the configuration:
```sh
kubectl delete -f kubernetes/blockchain-ca_deploy.yaml
```
...
```sh
kubectl delete -f kubernetes/blockchain-ca_svc.yaml
```
...
```sh
kubectl delete -f kubernetes/blockchain-orderer_deploy.yaml
```
...
Now, delete the configuration:
```sh
kubectl delete -f kubernetes/blockchain-orderer_svc.yaml
```
...
Now we're going to delete the previously created files:
```sh
kubectl delete -f kubernetes/blockchain-org1peer1_deploy.yaml
kubectl delete -f kubernetes/blockchain-org1peer2_deploy.yaml
kubectl delete -f kubernetes/blockchain-org1peer1_svc.yaml
kubectl delete -f kubernetes/blockchain-org1peer2_svc.yaml
```
...
Now we're going to delete the previously created files:
```sh
kubectl delete -f kubernetes/blockchain-org2peer1_deploy.yaml
kubectl delete -f kubernetes/blockchain-org2peer2_deploy.yaml
kubectl delete -f kubernetes/blockchain-org2peer1_svc.yaml
kubectl delete -f kubernetes/blockchain-org2peer2_svc.yaml
```
...
Now we're going to delete the previously created files:
```sh
kubectl delete -f kubernetes/blockchain-org3peer1_deploy.yaml
kubectl delete -f kubernetes/blockchain-org3peer2_deploy.yaml
kubectl delete -f kubernetes/blockchain-org3peer1_svc.yaml
kubectl delete -f kubernetes/blockchain-org3peer2_svc.yaml
```
...
Now we're going to delete the previously created files:
```sh
kubectl delete -f kubernetes/blockchain-org4peer1_deploy.yaml
kubectl delete -f kubernetes/blockchain-org4peer2_deploy.yaml
kubectl delete -f kubernetes/blockchain-org4peer1_svc.yaml
kubectl delete -f kubernetes/blockchain-org4peer2_svc.yaml
```
...
Now we're going to delete the configuration:
```sh
kubectl delete -f kubernetes/blockchain-explorer-db_deploy.yaml
```
...
Now we're going to delete the configuration:
```sh
kubectl delete -f kubernetes/blockchain-explorer-db_svc.yaml
```
...
Now its time to delete our `Deployment`:
```sh
kubectl delete -f kubernetes/blockchain-explorer-app_deploy.yaml
```
